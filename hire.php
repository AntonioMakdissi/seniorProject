...
<body class="bg-gray-100">
               ...
               -->
                <div id="hire">
                    <form id="hireForm" action="php/hire.php" method="post" class="php-email-form grid grid-cols-1 gap-6 md:grid-cols-2" style="padding-top: 20px;">
                        ...
                        <button type="submit" class=" md:col-span-2 w-full py-2 px-4 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Hire</button>
                    </form>
                    ...
                    <div id="success-modal" class="fixed z-10 hidden inset-0 overflow-y-auto">
                        <div class="flex items-center justify-center min-h-screen px-4 py-4 text-center sm:block sm:p-0">
                            ...
                            <div class="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-auto mx-auto my-8 align-middle max-w-md">
                                <div class="bg-green-500 border-green-600 text-white rounded-lg shadow-lg p-6">
                                    ...
                                    <button id="close-success-modal" class="mt-4 px-4 py-2 bg-green-700 text-white font-semibold rounded hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
                                        Close
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-center min-h-screen px-4 py-4 text-center sm:block sm:p-0">
                            ...
                            <div class="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-auto mx-auto my-8 align-middle max-w-md">
                                <div class="bg-red-500 border-red-600 text-white rounded-lg shadow-lg p-6">
                                    ...
                                    <p></p>
                                    <button id="close-error-modal" class="mt-4 px-4 py-2 bg-red-700 text-white font-semibold rounded hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                        Close
                                    </button>
                                </div>
                            </div>
    ...
    <!-- dynamic select for branch location when selecting manager type -->
    <!-- <script>
    ...
    <!-- if we wanted to make 3 divs (hire , fire , add branch) in the same page and make the m appear dynamically -->
    <!-- <script>
        document.addEventListener('DOMContentLoaded', function () {
