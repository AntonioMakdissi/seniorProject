...
<form method="post" action="rating.php">
  ...
  <div class="rating">
    ...
    <div class="form-check form-check-inline">
      ...
      <label class="form-check-label" for="star5" title="5 stars">5 stars</label>
    </div>
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="radio" id="star4" name="rating" value="4">
      <label class="form-check-label" for="star4" title="4 stars">4 stars</label>
    </div>
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="radio" id="star3" name="rating" value="3">
      <label class="form-check-label" for="star3" title="3 stars">3 stars</label>
    </div>
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="radio" id="star2" name="rating" value="2">
      <label class="form-check-label" for="star2" title="2 stars">2 stars</label>
    </div>
    <div class="form-check form-check-inline">
      <input class="form-check-input" type="radio" id="star1" name="rating" value="1">
      <label class="form-check-label" for="star1" title="1 star">1 star</label>
    </div>
  </div>
