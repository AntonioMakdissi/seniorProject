    ...
    <div class="container mx-auto px-4 py-12">
      <div class="container" style="margin-top: 10px">
        ...
        <!-- <div class="md:col-span-2 mb-6">
            <label class="block text-sm font-medium text-white-700 mb-2" style="color:white;">Search for Worker:</label>
            <div class="flex">
              <form style="z-index: 9999;" id="searchForm" action="search.php" method="post">
                <input style="z-index: 9999;" name="worker" type="text" id="searchWorker"
                  placeholder="worker name, id or branch">
                <button style="z-index: 9999;" name="submit" type="submit" id="searchButton"
        ...
        <form style="z-index: 9999;" id="searchForm" action="search.php" method="post">
          <div class="search-container">
            ...
            <input class="search-input" type="text" id="search-input" placeholder="Enter worker name, ID, or branch">
            <button class="search-button" name="submit" type="submit" id="searchButton">Search</button>
            <a href="http://localhost/seniorProject/php/test.php"><button class="show-all-button" name="show"
